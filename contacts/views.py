...
def inquiry(request):
    if request.method == 'POST':
        ...
        contact=Contact(first_name=first_name,last_name=last_name,car_id=car_id,car_title=car_title,user_id=user_id,customer_need=customer_need,city=city,state=state,email=email,phone=phone,message=message)
